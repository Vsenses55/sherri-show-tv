import svgPaths from "./svg-8xjwz1z1gv";
...
function InputText() {
  return (
    <div className="content-stretch flex flex-col h-[50px] items-start justify-center relative shrink-0 w-[339px]" data-name="Input Text">
      <p className="css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#7a7a7a] text-[16px] w-full">|Placeholder text</p>
    </div>
  );
}
...
function Error() {
  return (
    <div className="content-stretch flex items-center justify-end overflow-clip relative shrink-0 size-[24px]" data-name="Error">
      <SearchClose />
    </div>
  );
}
...
function Input() {
  return (
    <div className="bg-[#f4f4f4] h-[50px] relative rounded-[4px] shrink-0 w-full" data-name="Input">
