...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<"colors" | "typography" | "spacing" | "components" | "css">("colors");
      ...
      <footer className="border-t border-slate-200 mt-20">
        <div className="max-w-screen-2xl mx-auto px-8 py-8">
          <p className="text-slate-500 text-center">
            Sherri Show TV Design System • Colors optimized for accessibility and brand consistency
          </p>
        </div>
      </footer>
    </div>
